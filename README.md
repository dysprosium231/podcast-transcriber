...
- **说话人区分**（可选）：基于 [sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx)，纯 CPU，跟两个转录引擎都能配合。转录完之后单独对同一段音频再分析一遍，只给每句话加一个说话人标签，不改动已经生成的时间戳，字幕同步不受影响。多人对话/辩论类节目的识别准确率不是100%，声音相似或者抢话严重的时候容易分错
...
4. **说话人区分**（可选）：想用的话勾选「启用说话人区分」，点「下载此模型」
